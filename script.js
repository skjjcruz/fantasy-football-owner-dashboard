...
// Draft Board button handler - UPDATED TO POINT TO VERSION 2
...
const url = `https://skjjcruz.github.io/Owner-Dashboard-4/?username=${encodeURIComponent(username)}&season=${encodeURIComponent(season)}`;
